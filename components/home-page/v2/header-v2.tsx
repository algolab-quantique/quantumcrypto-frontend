...
/**
 * HeaderV2 - V2 landing page header only.
 * Uses Wide QuantumCrypto logo instead of square icon to match IQ logo weight.
 * Keeps exact same height (py-1) as original header.
 */
const HeaderV2 = () => {
            ...
            text-primary-foreground">
                <div className="flex gap-x-11 items-center">
                    <div className="w-[250px] flex items-center">
                        <Link href={'/landingpagegame_progress'}>
