...
export const quantumcryptoLines: LanguageItem[] = [
    ...
    },
    {
        ...
        'component.dps.about.part11' : ' à la seconde impulsion, ',
        ...
        'component.dps.about.part21' : 'Prenons un exemple avec les bits b0 = 0, b1 = 0 et b2 = 1. On aura alors les états suivants',
        ...
        'component.dps.about.part34' : '50% de probabilités',
