...
export const quantumcryptoLines: LanguageItem[] = [
    {   // ... (English translations)
        ...
        'component.dps.about.part2' : 'Unlike the BB84 and E91 protocols which encode information in the <link2>polarization</link2> of <link3>photons</link3>, the DPS protocol encodes information in the <link4>phase</link4> of a <link5>pulse train</link5>.',
        'component.dps.about.part3' : 'The protocol begins with Alice sending single photons into a device comprising three paths: ',
    ...
    },
    {
        ...
        'component.dps.about.part2' : 'A diferencia de los protocolos BB84 y E91 que codifican la información en la <link2>polarización</link2> de los <link3>fotones</link3>, el protocolo DPS codifica la información en la <link4>fase</link4> de un <link5>tren de impulsos</link5>.',
        'component.dps.about.part3' : 'El protocolo comienza con Alice enviando fotones individuales a un dispositivo que comprende tres caminos: ',
